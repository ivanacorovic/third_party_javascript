...
;(function($){
  ...
  $.fn.nutritionLabel.defaultSettings = {
    ...
    urlBottomLink : 'http://www.ideus.me',
    //link name for the customizable link at the bottom
    nameBottomLink : 'Ideus',
    ...
    textNutritionFacts : 'Nutritivne<br/> vrijednosti',
    textDailyValues : 'Dnevna vrijednost',
    textServingSize : 'Serving Size',
    textServingsPerContainer : 'Servings Per Container',
    textAmountPerServing : 'Količina na 100g',
    textCalories : 'Kalorije',
    textFatCalories : 'Kalorije od masti',
    textTotalFat : 'Masti',
    textSatFat : 'Zasićene masti',
    textTransFat : 'Omega-3 masne kisjeline',
    textPolyFat : 'Višestruko nezasićene masne kisjeline',
    textMonoFat : 'Jednostruko nezasićene masne kisjeline',
    textCholesterol : 'Holesterol',
    textSodium : 'Soda',
    textTotalCarb : 'Ugljeni hidrati',
    textFibers : 'Vlakna',
    textSugars : 'Šećeri',
    textProteins : 'Proteini',
    textVitaminA : 'Vitamin A',
    textVitaminC : 'Vitamin C',
    textCalcium : 'Kalcijum',
    textIron : 'Gvožđe',
    ingredientList : 'None',
    textPercentDailyPart1 : 'Prosječne dnevne vrijednosti temelje se na dijeti od',
    textPercentDailyPart2 : 'kalorija. Vaš dnevni unos može biti viši ili niži u zavisnosti od vaših potreba za kalorijama.'
  };
